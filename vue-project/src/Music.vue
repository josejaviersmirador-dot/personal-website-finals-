...
const tracks = {
  ...
  rock4: { label: 'Rock', title: 'Iris', src: '/audio/rock4.mp3', color: 'linear-gradient(135deg, #434343 0%, #000000 100%)' },
  rock5: { label: 'Rock', title: 'The reason', src: '/audio/rock5.mp3', color: 'linear-gradient(135deg, #434343 0%, #000000 100%)' },
